...
function calculator(operador) {
  ...
  operador !== `*`||
  operador !== `/`||
  operador !== `%` ? 'operaçao invalida' : function(num1, num2){
    return 'Resultado da operação: '+ num1 +' '+ operador +' '+ num2 +' = '+ (num1 +operador+ num2)+'.';
  }
  */
