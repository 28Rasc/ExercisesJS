( function() {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/, 'Raul Anderson da Silva Cavalcanti' ) );

    /*
    Agora, substitua a palavra "brasileiro" por sua cidade natal e mostre no
    console.
    Ex: Se você for da São Paulo, substitua por "paul
    ista".
    */
    console.log( '\nTrocando naturalidade:' );

    console.log( text.replace( /brasileiro/, 'limoeirense' ) );
    ...
    */
    ...
    console.log( text.replace( /O Centauro de Luvas/g, function( captura ) {
    ...
    */
    ...
    var arg = 'março';
    console.log( 'O mês de '+ arg +' é representado pelo número '+ getMonthNumber( arg ) +'.' );
