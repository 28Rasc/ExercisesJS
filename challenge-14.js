(function() {
    ...
    */
    ...
    var operation2 = justMod2Or3.reduceRight( function( total, atual  ) {
            return ( total + 1 ) * atual;
    }, 0 );
    ...
    */
    ...
    var pName = name.reduce( function( total, atual  ) {
    ...
    */
    ...
    var index = numberObjects.indexOf( obj ) > -1
    ?'Existe um objeto { number: 2 } em numberObjects!'
    :'Não existe um objeto { number: 2 } em numberObjects ';
    ...
    */
    ...
    var index2 = numberObjects.lastIndexOf( obj, 2 ) > -1
    ?'Existe um objeto { number: 2 } em numberObjects!'
    :'Não existe um objeto { number: 2 } em numberObjects ';
    ...
    */
    ...
    console.log( Array.isArray( justMod2Or3 ) ? 'É um array: '+ justMod2Or3.toString() : 'Não é um array' );
