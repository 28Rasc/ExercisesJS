( function() {
    ...
    */
    ...
    /*
    Analise as funções abaio`myFunction`, `myFunction2` e `myFunction3`, e
    ...
    */
        console.log( sum ); // sum, recebe a função call.
    ...
    */
        ...
        var multiplication = calculator( 4, 8 );
    ...
    As suas respostas devem estar abaio os `console.log` referentes à cada
    chamada.
    */
