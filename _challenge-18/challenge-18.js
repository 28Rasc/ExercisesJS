( function() {
    ...
    */
    ...
    console.log( phase.match( /ju\w{3}/g ) );
    ...
    */
    ...
    var tagMatch = '<div><section><blockquote>Texto <img /></blockquote></section></div>';

    console.log( tagMatch.match(/<\w+>/g) );
    ...
    */
    ...
    var textTag = '<div><ul><li></li><li></li><li><span></span></li></ul></div>'; 

    console.log( textTag.match( /<\w+><\/\w+>/g ) );
